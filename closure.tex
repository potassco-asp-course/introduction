...
\begin{frame}{What is the meaning of a \alt<1>{logic program}{set~of\only<3->{~positive}~rules}?}
  ...
  \item<only@28-> \structure{Mathematical characterization}
    \begin{itemize}\normalsize
    \item<only@29-> A set $X$ of atoms is \alert{closed} under a positive program $P$ if
      \par\smallskip
    ...
    \item<only@56-> \structure{Mathematical answer} \ The ``meaning of $P$'' is given by\par the \alert{smallest} set of atoms closed under $P$
