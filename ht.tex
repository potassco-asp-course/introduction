...
\begin{frame}{The logic of Here-and-There (\HT)}
  \smallskip
  \begin{itemize}
  \item<2-> \structure{Formula} \
    \(
    \varphi \ ::= \ \bot \ \mid \ a \ \mid \ \varphi \land \varphi \ \mid \  \varphi \lor \varphi \ \mid \  \varphi \rightarrow \varphi
    \)
    \medskip
  \item<3-> \structure{Interpretation} \ A pair \tuple{H,T} of sets of atoms with $H \subseteq T$
    \begin{itemize}
    \item $H$ is called ``here'' and
    \item $T$ is called ``there''
    \end{itemize}
  \item<4-> \structure{Note} \ \tuple{H,T} is a simplified Kripke structure
    \medskip
  \item<5-> \structure{Intuition} \
    \begin{itemize}
...
\end{frame}
% ----------------------------------------------------------------------
\begin{frame}{Equilibrium models}{(Pearce'96)}
  \begin{itemize}
