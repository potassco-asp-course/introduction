% ----------------------------------------------------------------------
\begin{frame}{This is a stable model!}{Stable models of normal programs}

  \begin{itemize}
  \item <2-10> The \alert{reduct}, \reduct{P}{X}, of a program $P$ relative to
    a set $X$ of atoms is
    \begin{align*}
  ...
  \item<only@8-9> \structure{Procedural counterpart}
